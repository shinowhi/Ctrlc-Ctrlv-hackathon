# FIN-DEMO-2 · Chính sách mẫu cho hackathon
...
5. Không còn nghi vấn, danh mục hợp lệ, đủ ngân sách, số tiền 1..19.999.999 VNĐ → tự phê duyệt. Từ 20 triệu → U3 gửi GĐTC. Hóa đơn đã được duyệt có cùng nhà cung cấp/số hóa đơn → U1, không duyệt lại.
6. U1: người nộp bổ sung đúng chứng từ hoặc thủ quỹ kiểm tra và ghi câu trả lời/căn cứ, xác nhận đủ bốn kiểm tra minh chứng. Sau đó SQL đánh giá lại. Thủ quỹ không được bỏ qua ngân sách hoặc tự duyệt khoản từ 20 triệu.
